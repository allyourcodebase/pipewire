...
static struct {
	...
	{ SDL_PIXELFORMAT_XRGB4444, SPA_VIDEO_FORMAT_UNKNOWN,},
	{ SDL_PIXELFORMAT_XRGB1555, SPA_VIDEO_FORMAT_UNKNOWN,},
	{ SDL_PIXELFORMAT_XBGR1555, SPA_VIDEO_FORMAT_UNKNOWN,},
...
static inline struct spa_pod *sdl_build_formats(SDL_Renderer * renderer, struct spa_pod_builder *b)
{
	uint32_t i, c;
	...
	spa_pod_builder_add(b,
		SPA_FORMAT_VIDEO_size,      SPA_POD_CHOICE_RANGE_Rectangle(
							...
							&SPA_RECTANGLE(1,1),
							&SPA_RECTANGLE(max_texture_size, max_texture_size)),
